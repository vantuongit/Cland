...
public class AdminLandsController {
	...
	public String cat(@ModelAttribute("lands") Lands lands, RedirectAttributes rd, @RequestParam("file") MultipartFile file,
	...
	public String edit( @ModelAttribute("lands") Lands lands,BindingResult result,RedirectAttributes rd,ModelMap modelMap,@RequestParam("file") MultipartFile file, HttpServletRequest request) {
			String fileName = FileUtil.upload(file,request);
