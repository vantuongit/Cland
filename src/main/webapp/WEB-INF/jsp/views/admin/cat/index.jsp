...
<c:if test="${not empty msg }">
								...
								<tr class="odd gradeX">
									...
									<td class="center text-center"><a href="${pageContext.request.contextPath}/admin/cat/edit/${item.cid}" title=""
										class="btn btn-primary"><span
											...
											<a href="${pageContext.request.contextPath}/admin/cat/delete/${item.cid}"
	...
	<nav class="text-center" aria-label="...">
		<ul class="pagination">
			<li class="disabled"><a href="${pageContext.request.contextPath}/admin/cat/index/${currentPage-1}" aria-label="Previous"><span
					aria-hidden="true">«</span></a></li>
					<c:forEach begin="1" end="${totalPage }" var="i">
						<li class='<c:if test="${i == currentPage }" >active</c:if>'><a href=" ${pageContext.request.contextPath}/admin/cat/index/${i}">${i} <span class="sr-only">(current)</span></a></li>
					</c:forEach>
